package my.jalal.made.core.di

import androidx.room.Room
import my.jalal.made.core.data.source.GameRepository
import my.jalal.made.core.data.source.local.LocalDataSource
import my.jalal.made.core.data.source.local.room.GameDatabase
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("jalal".toCharArray())
